...
please use the [issue tracker](https://github.com/Materials-Data-Science-and-Informatics/dirschema/issues).
...
```
git clone git@github.com:Materials-Data-Science-and-Informatics/dirschema.git
cd dirschema
